...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private boolean matchExpand = false;

	public boolean isMatchExpand() {
		return matchExpand;
	}

	public void setMatchExpand(boolean matchExpand) {
		this.matchExpand = matchExpand;
	}
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		matchExpand = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsMatchExpand, matchExpand);
	...
	private void setTextHighlight(int pos) {
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				TextView tab = (TextView) v;
				if (i == pos)
					tab.setTextColor(getResources().getColor(R.color.ch_green_1));
				else
					tab.setTextColor(tabTextColor);
			}
		}
