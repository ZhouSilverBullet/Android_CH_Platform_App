...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LogUtil.errorLog("当前的activity---->"+activity.toString());
		initAnims();
		...
		lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewUtil.dp2px(mvp.getContext(), 50));
		...
		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(
				ViewGroup.LayoutParams.MATCH_PARENT, ViewUtil.dp2px(mvp.getContext(), 40));
		lp22.setMargins(10, ViewUtil.dp2px(mvp.getContext(), 5), 10, ViewUtil.dp2px(mvp.getContext(), 5));
