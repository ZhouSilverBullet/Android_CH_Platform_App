...
public class RiffEffectLinearLayout extends LinearLayout {

    private CircleBtnHelper mHelper = null;

    public RiffEffectLinearLayout(Context context){
        super(context);
        init();
    }

    public RiffEffectLinearLayout(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public RiffEffectLinearLayout(Context context, AttributeSet attrs, int defStyleAttr){
