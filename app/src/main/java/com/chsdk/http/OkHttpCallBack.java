...
class OkHttpCallBack implements Callback {
    ...
    public OkHttpCallBack(IRequestListener listener) {
                ...
                if (jsonObject != null && listener != null) {
                    ...
                    if (code != HttpConsts.CODE_SUCCESS) {
                        ...
                        if (data instanceof JSONObject) {
                            listener.success(JsonUtil.getMapFromJson((JSONObject) data));
                        } else if (data instanceof JSONArray) {
                            HashMap<String, String> map = new HashMap<>();
                            map.put(HttpConsts.RESULT_PARAMS_DATA, data.toString());
