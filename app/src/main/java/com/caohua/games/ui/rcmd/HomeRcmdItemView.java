...
public class HomeRcmdItemView extends RiffEffectRelativeLayout implements DataInterface {
    ...
    public HomeRcmdItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        loadXml();
    }

    private void loadXml() {
        LayoutInflater.from(getContext()).inflate(R.layout.ch_view_home_rcmd_item, this, true);
    ...
    public void setData(Object o) {
        ...
        DailyRcmdEntry entry = (DailyRcmdEntry) o;
    ...
    private void init() {
        imgIcon = (ImageView) findViewById(R.id.ch_view_home_rcmd_item_icon);
        tvTitle = (TextView) findViewById(R.id.ch_view_home_rcmd_item_title);
        tvType = (TextView) findViewById(R.id.ch_view_home_rcmd_item_type_and_size);
        tvDes = (TextView) findViewById(R.id.ch_view_home_rcmd_item_des);
        downloadMgr = new ViewDownloadMgr((DownloadButton) findViewById(R.id.ch_view_home_rcmd_item_btn));

        setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                AnalyticsHome.umOnEvent(AnalyticsHome.HOME_DAY_RECOMMEND_CLICK_ANALYTICS,"游戏专区二级界面");
