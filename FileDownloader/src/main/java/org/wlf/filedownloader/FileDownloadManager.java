...
public final class FileDownloadManager {
     ...
     */
    @Deprecated
    public void detect(DownloadParams url, OnDetectUrlFileListener onDetectUrlFileListener) {
     ...
     */
    public void detect(DownloadParams url, OnDetectBigUrlFileListener onDetectBigUrlFileListener) {
    ...
    /**
     * create a new download after detected a url file by using {@link #detect(DownloadParams, OnDetectUrlFileListener)}
     * <br/>
     ...
     * @since 0.2.0
     */
    public void start(DownloadParams params) {
        getDownloadTaskManager().start(params, null);
    }
     ...
     * @param params                          file url
     * @param onFileDownloadStatusListener OnFileDownloadStatusListener impl
     * @deprecated use {@link #start(DownloadParams)} instead
     */
    @Deprecated
    public void start(DownloadParams params, OnFileDownloadStatusListener onFileDownloadStatusListener) {

        DownloadStatusConfiguration.Builder builder = new Builder();
        builder.addListenUrl(params.url);
        builder.configAutoRelease(true);
        registerDownloadStatusListener(onFileDownloadStatusListener, builder.build());
     ...
     * @since 0.2.0
     */
    public void start(List<DownloadParams> urls) {
     ...
     */
    @Deprecated
    public void start(List<DownloadParams> urls, OnFileDownloadStatusListener onFileDownloadStatusListener) {

        DownloadStatusConfiguration.Builder builder = new Builder();
        for (DownloadParams params : urls) {
            builder.addListenUrl(params.url);
        }
        builder.configAutoRelease(true);
        registerDownloadStatusListener(onFileDownloadStatusListener, builder.build());
     ...
     * @since 0.2.0
     */
    public void reStart(DownloadParams params) {
        getDownloadTaskManager().reStart(params, null);
    }
     ...
     * @param params                          file url
     * @param onFileDownloadStatusListener OnFileDownloadStatusListener impl
     * @deprecated use {@link #reStart(DownloadParams)} instead
     */
    @Deprecated
    public void reStart(DownloadParams params, OnFileDownloadStatusListener onFileDownloadStatusListener) {
     ...
     * @since 0.2.0
     */
    public void reStart(List<DownloadParams> urls) {
     ...
     */
    @Deprecated
    public void reStart(List<DownloadParams> urls, OnFileDownloadStatusListener onFileDownloadStatusListener) {
     ...
     * @since 0.3.2
     */
    void detect(DownloadParams url, OnDetectBigUrlFileListener onDetectBigUrlFileListener, DownloadConfiguration
     ...
     * @since 0.3.2
     */
    void start(DownloadParams params, DownloadConfiguration downloadConfiguration) {
        getDownloadTaskManager().start(params, downloadConfiguration);
    }
     ...
     * @since 0.3.2
     */
    void start(List<DownloadParams> urls, DownloadConfiguration downloadConfiguration) {
     ...
     * @since 0.3.2
     */
    void reStart(DownloadParams url, DownloadConfiguration downloadConfiguration) {
     ...
     * @since 0.3.2
     */
    void reStart(List<DownloadParams> urls, DownloadConfiguration downloadConfiguration) {
