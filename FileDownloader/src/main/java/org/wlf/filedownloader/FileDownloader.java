...
public final class FileDownloader {
     ...
     */
    @Deprecated
    public static void detect(DownloadParams url, OnDetectUrlFileListener onDetectUrlFileListener) {
     ...
     * @since 0.3.0
     */
    public static void detect(DownloadParams url, OnDetectBigUrlFileListener onDetectBigUrlFileListener) {
    ...
    public static void detect(DownloadParams url, OnDetectBigUrlFileListener onDetectBigUrlFileListener,
        ...
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrl(url.url);
        }
     ...
     */
    public static void start(DownloadParams params) {
        getFileDownloadManager().start(params);
    }
     ...
     * @since 0.3.2
     */
    public static void start(DownloadParams params, DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrl(params.url);
        }
        getFileDownloadManager().start(params, downloadConfiguration);
    }
     ...
     */
    public static void start(List<DownloadParams> urls) {
     ...
     * @since 0.3.2
     */
    public static void start(List<DownloadParams> urls, DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
    ...
    public static void continueAll(boolean isIncludedErrorDownloads, DownloadConfiguration downloadConfiguration) {
        ...
        List<DownloadParams> urls = new ArrayList<DownloadParams>();
     ...
     * @param url file url
     */
    public static void reStart(DownloadParams url) {
     ...
     * @since 0.3.2
     */
    public static void reStart(DownloadParams url, final DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrl(url.url);
        }
     ...
     * @param urls file urls
     */
    public static void reStart(List<DownloadParams> urls) {
