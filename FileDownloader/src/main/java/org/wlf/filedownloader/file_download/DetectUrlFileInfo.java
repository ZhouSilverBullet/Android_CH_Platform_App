...
public class DetectUrlFileInfo extends BaseUrlFileInfo {
    ...
    DetectUrlFileInfo(String url, long fileSize, String eTag, String lastModified, String acceptRangeType, String 
            fileDir, String fileName, String title, String pkg, String iconUrl) {
        super();
        this.mUrl = url;
    ...
    void update(DetectUrlFileInfo detectUrlFileInfo) {
        ...
        if (!TextUtils.isEmpty(detectUrlFileInfo.mTitle)) {
            this.mTitle = detectUrlFileInfo.mTitle;
        }
        if (!TextUtils.isEmpty(detectUrlFileInfo.mPkg)) {
            this.mPkg = detectUrlFileInfo.mPkg;
        }
        if (!TextUtils.isEmpty(detectUrlFileInfo.mIconUrl)) {
            this.mIconUrl = detectUrlFileInfo.mIconUrl;
        }
