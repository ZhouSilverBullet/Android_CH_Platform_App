...
class DetectUrlFileTask implements Runnable {
    ...
    public DetectUrlFileTask(DownloadParams params, String downloadSaveDir, DetectUrlFileCacher detectUrlFileCacher,
                             DownloadRecorder downloadRecorder) {
        super();
        this.mUrl = params.url;
        this.mPkg = params.pkg;
        ...
        try {
            ...
            switch (conn.getResponseCode()) {
                ...
                case HttpURLConnection.HTTP_OK:
                    ...
                    fileName = mTitle + mUrl.hashCode() + ".apk";
                    // get eTag
                    ...
                    if (fileSize > 0) {
                        detectUrlFileInfo = new DetectUrlFileInfo(mUrl, fileSize, eTag, lastModified,
                                acceptRangeType, mDownloadSaveDir, fileName, mTitle, mPkg, iconUrl);
